...
void Visuals::Player::RenderName()
{
	...
	Render::Get().RenderText(info.szName, ctx.feet_pos.x - sz.x / 2, ctx.head_pos.y - sz.y, 14.f,  ctx.clr, g_pDefaultFont);
}
//--------------------------------------------------------------------------------
void Visuals::Player::RenderHealth()
{
	...
	Render::Get().RenderBoxFilled(x, y, x + w, y + h, ImColor(0,0,0), 1.f);
	Render::Get().RenderBoxFilled(x + 1, y + 1, x + w - 1, y + height - 2, ImColor(red, green, 0, 255), 1.f);
}
//--------------------------------------------------------------------------------
void Visuals::Player::RenderArmour()
{
	...
	Render::Get().RenderBoxFilled(x, y, x + w, y + h, ImColor(0,0,0));
	Render::Get().RenderBoxFilled(x + 1, y + 1, x + w - 1, y + height - 2, ImColor(0, 50, 255, 255), 1.f);
}
//--------------------------------------------------------------------------------
void Visuals::Player::RenderWeaponName()
{
	...
	Render::Get().RenderText(text, ctx.feet_pos.x, ctx.feet_pos.y, 14.f, ctx.clr,
		g_pDefaultFont);
}
//--------------------------------------------------------------------------------
...
void Visuals::RenderWeapon(C_BaseCombatWeapon* ent)
{
	...
	Render::Get().RenderText(name, (bbox.left + w * 0.5f) - sz.x * 0.5f, (float)bbox.bottom + 1, 14.f, g_Options.color_esp_weapons, g_pDefaultFont);
}
//--------------------------------------------------------------------------------
void Visuals::RenderDefuseKit(C_BaseEntity* ent)
{
	...
	auto sz = g_pDefaultFont->CalcTextSizeA(14.f, FLT_MAX, 0.0f, name);
	int w = bbox.right - bbox.left;
	Render::Get().RenderText(name, (bbox.left + w * 0.5f) - sz.x * 0.5f, (float)bbox.bottom + 1, 14.f, g_Options.color_esp_defuse, g_pDefaultFont);
}
//--------------------------------------------------------------------------------
void Visuals::RenderPlantedC4(C_BaseEntity* ent)
{
	...
	Render::Get().RenderText(name, (bbox.left + w * 0.5f) - sz.x * 0.5f, (float)bbox.bottom + 1, 14.f, g_Options.color_esp_c4, g_pDefaultFont);
}
//--------------------------------------------------------------------------------
void Visuals::RenderItemEsp(C_BaseEntity* ent)
{
	...
	Render::Get().RenderText(itemstr, (bbox.left + w * 0.5f) - sz.x * 0.5f, (float)bbox.bottom + 1, 14.f, g_Options.color_esp_item, g_pDefaultFont);
}
//--------------------------------------------------------------------------------
