...
struct ImColor
{
    ...
    {
       Value.x = (unsigned char)_r;
       Value.y = (unsigned char)_g;
       Value.w = (unsigned char)_b;
       Value.z = (unsigned char)_a;
    }
    inline void SetColor(float _r, float _g, float _b, float _a)
    {
       Value.x = static_cast<unsigned char>(_r * 255.0f);
       Value.y = static_cast<unsigned char>(_g * 255.0f);
       Value.w = static_cast<unsigned char>(_b * 255.0f);
       Value.z = static_cast<unsigned char>(_a * 255.0f);
    }
