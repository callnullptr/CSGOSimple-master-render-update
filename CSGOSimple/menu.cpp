...
namespace ImGuiEx
{
    inline bool ColorEdit4(const char* label, ImColor* v, bool show_alpha = true)
    {
        auto clr = ImVec4{
            v->Value.x / 255.0f,
            v->Value.y / 255.0f,
    ...
    inline bool ColorEdit3(const char* label, ImColor* v)
    {
...
void Menu::Render()
{
    ...
    Render::Get().RenderDrawData(pBackgroundDrawList);
